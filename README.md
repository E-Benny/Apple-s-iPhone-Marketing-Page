## Apple's iPhone Marketing Page
This repository contains an HTML file that displays the modern UI layout of a marketing page designed to market Apple's latest product, The iPhone 13. this project was developed using HTML, SCSS and Responsive Web Design.
...
## Live Version
To view the live version of the code without downloading the HTML file, please click on the CodePen link (https://codepen.io/E-Benny/pen/KKQYaXK).
